...
public class MBJInstance_Delta {
...
//        String outPutName = "FM-MBJ-Small-scale-Change-delta";
//        String ReadPath = "src/main/M-Machine-Instances/";

//        // Large-scale
        int[] J_instances = {40,60,80,100};
        int[] D_instances = {0, 5, 10, 15, 20};
        int[] C_instances = {4,5,6,7,8,9,10};
        String outPutName = "FM-MBJ-Large-scale-Change-delta";
        String ReadPath = "src/main/M-Machine-LargeInstances/";
...
//        int delta = 1;  // Forgetting factor
        ...
        double[][] Gap0 = new double[J_instances.length * C_instances.length * M_instances.length* D_instances.length][2]; // Gap0 = (optPFSP-optMBJ)* 100/optMBJ, average and maximum
        double[][] Gap1 = new double[J_instances.length * C_instances.length * M_instances.length* D_instances.length][2]; // Gap1 = (optMBJ-optBW)* 100/optBW, average and maximum
        double[][] Gap2 = new double[J_instances.length * C_instances.length * M_instances.length* D_instances.length][2]; // Gap2 = (optMBJ-opt)* 100/opt, average and maximum
        double[] averTime = new double[J_instances.length * C_instances.length * M_instances.length* D_instances.length];
...
//                            // All permutations of batches
                            ...
                            long durationMicro_2 = (endTime_2 - startTime_2) / 1000;
                            cputime[itt - 1] = durationMicro_2;
                        }
                        ...
                        // Data storage
                        Object[] data_s = new Object[]{ins,delta, J, C, M, Gap0[ins][0], Gap0[ins][1],Gap1[ins][0], Gap1[ins][1],
