...
/*
    Read the F2 instances and solve them by BJ rule
 */
...
public class BJInstance {
    public static void main(String[] args) throws IOException {
        /*  Number of iterations  */
        int Ite = 5;

        // Files optput path
        String outPutName = "F2-BJ-Instances";
        ...
        double[][] Gap0 = new double[J_instances.length * C_instances.length][2]; // Benefit of CLFE = (optPFSPandCLFE-opt)* 100/opt, average and maximum
        double[][] Gap1 = new double[J_instances.length * C_instances.length][2]; // Benefit of CLFE = (optPFSP-opt)* 100/opt, average and maximum
        double[][] Gap2 = new double[J_instances.length * C_instances.length][2]; // Gap = (optBW-opt)* 100/opt, average and maximum
        double[][] Delta1 = new double[J_instances.length * C_instances.length][2]; // Delta1 = (opt-LB)* 100/opt, average and maximum
        double[][] Delta2 = new double[J_instances.length * C_instances.length][2]; // Delta2 = (opt-LB)* 100/LB, average and maximum
        double[] averTime = new double[J_instances.length * C_instances.length];
        ...
        for (int J : J_instances){
            ...
            for (int C : C_instances){
                ...
                for (int itt = 1; itt <= Ite; itt++) {
                    ...
                    // Read path
                    String filePath = "src/main/Two-Machine-Instances/"+J+"-"+C+"-"+M+"-"+itt+".txt";
...
//                    Calculation.printArray(PT);
                    ...
                    System.out.println(optMS+"---"+makespan+"---"+lb+"---"+LB[itt-1]);
                }
                ...
                // Data storage
                Object[] data_s = new Object[]{ins,J,C,M,Gap0[ins][0], Gap0[ins][1], Gap1[ins][0],Gap1[ins][1],Gap2[ins][0],Gap2[ins][1],
